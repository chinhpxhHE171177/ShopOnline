...
public class Home2Servlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Product> listpro = new ProductDAO().getDrinkProducts();
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            switch (sortBy) {
                case "price-up":
                    list = (ArrayList<Product>) pdao.sortDrinkByPriceUp();
                    selectedOption = "price-up";
                    break;
                case "price-down":
                    list = (ArrayList<Product>) pdao.sortDrinkByPriceDown();
                    selectedOption = "price-down";
                    break;
                case "name-up":
                    list = (ArrayList<Product>) pdao.sortDrinkByNameUp();
                    selectedOption = "name-up";
                    break;
                case "name-down":
                    list = (ArrayList<Product>) pdao.sortDrinkByNameDown();
            ...
            request.setAttribute("error", "Not Found Drink");
        }
    }
