...
public class Home1Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listpro = new ProductDAO().getFoodProducts();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (sortBy) {
                case "price-up":
                    list = (ArrayList<Product>) pdao.sortFoodByPriceUp();
                    selectedOption = "price-up";
                    break;
                case "price-down":
                    list = (ArrayList<Product>) pdao.sortFoodByPriceDown();
                    selectedOption = "price-down";
                    break;
                case "name-up":
                    list = (ArrayList<Product>) pdao.sortFoodByNameUp();
                    selectedOption = "name-up";
                    break;
                case "name-down":
                    list = (ArrayList<Product>) pdao.sortFoodByNameDown();
            ...
            request.setAttribute("error", "Not Found Food");
        }
    }
