 ...
 * @author Admin
 */
@WebServlet(name = "SearchByPriceServlet", urlPatterns = {"/search-price"})
public class SearchByPriceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            switch (searchByPrice) {
                case "1":
                    list = (ArrayList<Product>) pdao.searchProductByPrice1();
                    selectedOption = "1";
                    break;
                case "2":
                    list = (ArrayList<Product>) pdao.searchProductByPrice2();
                    selectedOption = "2";
                    break;
                case "3":
                    list = (ArrayList<Product>) pdao.searchProductByPrice3();
                    selectedOption = "3";
                    break;
            }
            ...
            request.setAttribute("listprice", selectedOption);
