        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white font-monospace">
                    <h1>Coffee</h1>
                    <h5>The strong flavor of coffee is passionate and helps stay awake</h5>
                        ...
                        <div class="col mb-5">
                            ...
                            <div class="card h-100">
                                ...
                                <a href="detail?productId=${p.id}">
                                    <img class="card-img-top" src="images_coffee/${p.imageUrl}" width="100%" height="300px"
                                         alt="..." />
                                </a>
                                <!-- Product details-->
...
<!--                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" onclick="addToCartAsync(${p.id})">Add to
                                    ...
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="add-to-cart3?productId=${p.id}">Add to
                                            cart</a>
                                    </div>
                                </div>
                            </div>
                ...
                <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                    <ul class="pagination">
                        <li class="page-item ${page == 1 ? 'disabled' : ''}">
                            <a class="page-link" href="home3?page=${page-1}" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <c:forEach begin="1" end="${totalPage}" var="i">
                            <li class="page-item ${i == page ? 'active' : ''}">
                                <a class="page-link" href="home3?page=${i}">${i}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item ${page == totalPage ? 'disabled' : ''}">
                            <a class="page-link" href="home3?page=${page+1}" aria-label="Next">
